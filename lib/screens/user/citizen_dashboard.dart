        ...
        children: [
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(color: Color(0xFF4F46E5).withOpacity(0.5), blurRadius: 20, offset: Offset(0, 8)),
                      ],
                    ),
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text('Report Issue', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 16)),
                      ],
                    ),
                  ),
                ),
          ...
          StreamBuilder<List<Issue>>(
            ...
            builder: (context, snapshot) {
              ...
              return Row(
                children: [
                  _buildStatCard('Total Reports', issues.length.toString(), Icons.folder_rounded, [Color(0xFF4F46E5), Color(0xFF6366F1)]),
                  SizedBox(width: 24),
          ...
          SizedBox(height: 48),
          Text('Recent Activity', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Color(0xFF0F172A), letterSpacing: -0.3)),
          SizedBox(height: 24),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 24),
            Text(value, style: TextStyle(fontSize: 44, fontWeight: FontWeight.w900, color: Color(0xFF0F172A), letterSpacing: -1.5, height: 1)),
            SizedBox(height: 8),
